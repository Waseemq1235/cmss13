...
/obj/structure/machinery/prop/antiair_mainframe
	name = "SSDC Mainframe"
	desc = "The mainframe controlling the Sputnik Stratospheric Defense Cannon. Destroying this would enable ships to land on the western and eastern landing pads. It is well-protected from small arms, hence you must use a C4 brick."
...
/obj/structure/machinery/prop/antiair_mainframe/Destroy(force)
	if(!force)
		...
		marine_announcement(destroy_announcement, destroy_title, "sound/AI/commandreport.ogg", FACTION_UPP)
		message_admins(FONT_SIZE_XL("The AA mainframe has been destroyed. In-land landing zones are now available."))
